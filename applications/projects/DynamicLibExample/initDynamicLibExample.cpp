...
#include <sofa/helper/system/config.h>
	...
	#define SOFA_DYNAMICLIBEXAMPLEAPI
#else
...
namespace component
{
	...
	extern "C" {
		SOFA_DYNAMICLIBEXAMPLEAPI void initExternalModule();
		SOFA_DYNAMICLIBEXAMPLEAPI char* getModuleName();
		SOFA_DYNAMICLIBEXAMPLEAPI char* getModuleDescription();
		SOFA_DYNAMICLIBEXAMPLEAPI char* getModuleComponentList();
	}
