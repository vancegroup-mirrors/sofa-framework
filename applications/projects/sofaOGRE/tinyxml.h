...
/***************************************************************************************************/
/// MOD by cTh, mods to export tiXML classes from the generated DLL/lib
...
/** TiXmlBase is a base class for every class in TinyXml.
	...
	@endverbatim
*/
class DOTSCENEINTERFACE_API TiXmlBase
{
...
*/
class DOTSCENEINTERFACE_API TiXmlNode : public TiXmlBase
{
	friend class TiXmlDocument;
	friend class TiXmlElement;
...
*/
class DOTSCENEINTERFACE_API TiXmlAttribute : public TiXmlBase
{
...
*/
class DOTSCENEINTERFACE_API TiXmlAttributeSet
{
public:
	TiXmlAttributeSet();
	~TiXmlAttributeSet();
...
*/
class DOTSCENEINTERFACE_API TiXmlElement : public TiXmlNode
{
public:
...
/**	An XML comment.
*/
class DOTSCENEINTERFACE_API TiXmlComment : public TiXmlNode
{
public:
...
*/
class DOTSCENEINTERFACE_API TiXmlText : public TiXmlNode
{
	friend class TiXmlElement;
public:
	/// Constructor.
...
*/
class DOTSCENEINTERFACE_API TiXmlDeclaration : public TiXmlNode
{
public:
...
/** Any tag that tinyXml doesn't recognize is save as an
	...
	is saved.
*/
class DOTSCENEINTERFACE_API TiXmlUnknown : public TiXmlNode
{
public:
...
*/
class DOTSCENEINTERFACE_API TiXmlDocument : public TiXmlNode
{
public:
