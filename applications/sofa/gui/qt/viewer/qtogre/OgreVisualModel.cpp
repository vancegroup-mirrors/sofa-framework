...
, materialname(dataField(&materialname, "materialname", "material name"))
, colorname(dataField(&colorname, "color" , "color"))
, dx(dataField(&dx, 0.0f, "dx" , "Initial coordinate in X"))
, dy(dataField(&dy, 0.0f, "dy" , "Initial coordinate in Y"))
, dz(dataField(&dz, 0.0f, "dz" , "Initial coordinate in Z"))
, scale(dataField(&scale, 1.0f, "scale" , "scale"))
, scaleTex(dataField(&scaleTex, 1.0f, "scaleTex" , "scale of the texture")) //TODO
, topology(NULL)
, nbNormals(0)
