...
simulation::Node *ObjectCreator::CreateRootWithCollisionPipeline(const std::string &simulationType, const std::string& responseType)
  ...
  simulation::Node *ObjectCreator::CreateEulerSolverNode(const std::string& name, const std::string &scheme)
  {
  simulation::Node* node = simulation::getSimulation()->newNode(name.c_str());
