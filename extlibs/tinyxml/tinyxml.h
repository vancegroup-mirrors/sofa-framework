...
public:
	    ...
	    */
	    SOFA_TINYXML_API friend std::istream& operator >> (std::istream& in, TiXmlNode& base);
	    ...
	    */	
	    SOFA_TINYXML_API friend std::ostream& operator<< (std::ostream& out, const TiXmlNode& base);

		/// Appends the XML node or attribute to a std::string.
		SOFA_TINYXML_API friend std::string& operator<< (std::string& out, const TiXmlNode& base );
