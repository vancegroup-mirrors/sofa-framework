...
class ParallelMultiVector: public  sofa::core::componentmodel::behavior::MultiVector<Parent>
{
public:
...
public:
    ...
    ParallelMultiVector(Parent* parent, VecId v) : sofa::core::componentmodel::behavior::MultiVector<Parent>(parent,v)
    {}
