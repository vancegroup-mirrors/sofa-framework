...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  void DrawManagerGL::drawPoints(const std::vector<Vector3> &points, float size, const Vec<4,float> colour=Vec<4,float>(1.0f,1.0f,1.0f,1.0f))
  {
    setMaterial(colour);
    glPointSize(size);
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  void DrawManagerGL::drawLines(const std::vector<Vector3> &points, float size, const Vec<4,float> colour)
  {
    setMaterial(colour);
    glLineWidth(size);    
    glDisable(GL_LIGHTING);    
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  void DrawManagerGL::drawLines(const std::vector<Vector3> &points, const std::vector< defaulttype::Vec<2,int> > &index, float size, const Vec<4,float> colour=Vec<4,float>(1.0f,1.0f,1.0f,1.0f))
  {
    setMaterial(colour);
    glLineWidth(size);
    glDisable(GL_LIGHTING);
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  void DrawManagerGL::drawTriangles(const std::vector<Vector3> &points, const Vec<4,float> colour)
  { 
    setMaterial(colour);
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  void DrawManagerGL::drawTriangles(const std::vector<Vector3> &points, const Vector3 normal, const Vec<4,float> colour)
  {
    setMaterial(colour);
    glBegin(GL_TRIANGLES);
    {
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  void DrawManagerGL::drawTriangles(const std::vector<Vector3> &points, const std::vector< defaulttype::Vec<3,int> > &index, 
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  void DrawManagerGL::drawTriangles(const std::vector<Vector3> &points,
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  void DrawManagerGL::drawTriangleStrip(const std::vector<Vector3> &points,
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  void DrawManagerGL::drawTriangleFan(const std::vector<Vector3> &points,
                                      const std::vector<Vector3>  &normal,
                                      const Vec<4,float> colour)
  {
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  void DrawManagerGL::drawFrame(const Vector3& position, const Quaternion &orientation, const Vec<3,float> &size)
  {
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  void DrawManagerGL::drawSpheres(const std::vector<Vector3> &points, float radius, const Vec<4,float> colour)
  {
    setMaterial(colour);
    for (unsigned int i=0;i<points.size();++i)
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  void DrawManagerGL::drawSpheres(const std::vector<Vector3> &points, const std::vector<float>& radius, const Vec<4,float> colour)
  {      
    setMaterial(colour);
    for (unsigned int i=0;i<points.size();++i)
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  void DrawManagerGL::drawCone(const Vector3& p1, const Vector3 &p2, float radius1, float radius2, const Vec<4,float> colour, int subd)
    {
      Vector3 tmp = p2-p1;
      setMaterial(colour);
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  void DrawManagerGL::drawCube( const float& radius, const Vec<4,float>& colour, const int& subd)
  {
      // X Axis
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  void DrawManagerGL::drawCylinder(const Vector3& p1, const Vector3 &p2, float radius, const Vec<4,float> colour, int subd)
  {      
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  void DrawManagerGL::drawArrow(const Vector3& p1, const Vector3 &p2, float radius, const Vec<4,float> colour,  int subd)
  {
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  void DrawManagerGL::drawPlus ( const float& radius, const Vec<4,float>& colour, const int& subd)
  {
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  void DrawManagerGL::addPoint(const Vector3 &p, const Vec<4,float> &c)
  {
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  void DrawManagerGL::addPoint(const Vector3 &p, const Vector3 &n, const Vec<4,float> &c)
  { 
	glColor4f(c[0],c[1],c[2],c[3]);
	glNormalT(n);
	glVertexNv<3>(p.ptr());
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  void DrawManagerGL::addTriangle(const Vector3 &p1,const Vector3 &p2,const Vector3 &p3,
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  void DrawManagerGL::addSphere( const Vector3 &p, float radius)
  { 
    glPushMatrix();
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  void DrawManagerGL::setPolygonMode(int _mode, bool _wireframe)
  {
    mPolygonMode=_mode;
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  void DrawManagerGL::setLightingEnabled(bool _isAnabled)
  {
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  void DrawManagerGL::setMaterial(const Vec<4,float> &colour,std::string)
  {
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  void DrawManagerGL::resetMaterial(const Vec<4,float> &colour,std::string)
  {
    if (colour[3] < 1)
    {
	glDisable(GL_BLEND);
