...
extern  		"C" {
	...
	extern Bool			glXQueryExtension(Display* dpy, int* error_base,
										  int* event_base);
	...
	extern void			glXUseXFont(Font font, int first, int count,
									int list_base);
	...
	extern Bool			glXMakeContextCurrent(Display* display,
											  GLXDrawable draw,
	...
	extern GLXContext	glXImportContextEXT(Display* dpy,
	 ...
	 * SGIX_swap_group
	*/ 
	extern void			glXJoinSwapGroupSGIX(Display* dpy,
	 ...
	 * SGIX_swap_barrier
	*/ 
	extern void			glXBindSwapBarrierSGIX(Display* dpy,
											   GLXDrawable drawable,
											   int barrier);
