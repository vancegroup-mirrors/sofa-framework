...
class ContactCorrection : public componentmodel::collision::BaseContactCorrection
{
public:
	...
	ContactCorrection(behavior::MechanicalState<DataTypes> *mm = NULL);

    virtual ~ContactCorrection();
    ...
    static std::string templateName(const ContactCorrection<DataTypes>* = NULL)
    {
