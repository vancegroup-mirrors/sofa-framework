...
******************************************************************************/
#ifndef SOFA_COMPONENT_COLLISION_LOCALMINDISTANCEFILTER_INL
#define SOFA_COMPONENT_COLLISION_LOCALMINDISTANCEFILTER_INL
...
bool InfoFilter< TCollisionElement >::isValid(void) const
{
...
template< class TCollisionElement >
void InfoFilter< TCollisionElement >::setValid()
{
	assert(m_lmdFilters != 0);
