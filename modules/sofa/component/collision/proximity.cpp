...
void DistanceTriTri::
NewComputation(Triangle *triP, Triangle *triQ, Vector3 &Presult, Vector3 &Qresult)
{
...
NewComputation(Triangle *tri, const Vector3 &Q, Vector3 &Presult)
{
	double alpha, beta;
	int i;
