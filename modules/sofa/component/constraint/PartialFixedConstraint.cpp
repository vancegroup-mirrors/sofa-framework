...
#include <sofa/component/constraint/PartialFixedConstraint.inl>
...
#ifndef SOFA_FLOAT
template class SOFA_COMPONENT_CONSTRAINT_API PartialFixedConstraint<Vec3dTypes>;
template class SOFA_COMPONENT_CONSTRAINT_API PartialFixedConstraint<Vec2dTypes>;
template class SOFA_COMPONENT_CONSTRAINT_API PartialFixedConstraint<Vec1dTypes>;
template class SOFA_COMPONENT_CONSTRAINT_API PartialFixedConstraint<Vec6dTypes>;
template class SOFA_COMPONENT_CONSTRAINT_API PartialFixedConstraint<Rigid3dTypes>;
template class SOFA_COMPONENT_CONSTRAINT_API PartialFixedConstraint<Rigid2dTypes>;
#endif
#ifndef SOFA_DOUBLE
template class SOFA_COMPONENT_CONSTRAINT_API PartialFixedConstraint<Vec3fTypes>;
template class SOFA_COMPONENT_CONSTRAINT_API PartialFixedConstraint<Vec2fTypes>;
template class SOFA_COMPONENT_CONSTRAINT_API PartialFixedConstraint<Vec1fTypes>;
template class SOFA_COMPONENT_CONSTRAINT_API PartialFixedConstraint<Vec6fTypes>;
template class SOFA_COMPONENT_CONSTRAINT_API PartialFixedConstraint<Rigid3fTypes>;
template class SOFA_COMPONENT_CONSTRAINT_API PartialFixedConstraint<Rigid2fTypes>;
#endif
