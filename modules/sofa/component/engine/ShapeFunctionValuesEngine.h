...
******************************************************************************/
#ifndef SOFA_COMPONENT_ENGINE_SHAPEFUNCTIONVALUESENGINE_H
#define SOFA_COMPONENT_ENGINE_SHAPEFUNCTIONVALUESENGINE_H
...
class ShapeFunctionValuesEngine : public core::DataEngine
{
public:
    SOFA_CLASS(SOFA_TEMPLATE(ShapeFunctionValuesEngine,DataTypes),core::DataEngine);
...
public:
    ...
    static std::string templateName(const ShapeFunctionValuesEngine<DataTypes>* = NULL)
    {
      return DataTypes::Name();
    }

    Data<bool> values;
    Data<bool> derivatives;
