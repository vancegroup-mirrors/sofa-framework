...
******************************************************************************/
#ifndef SOFA_COMPONENT_ENGINE_SHAPEFUNCTIONVALUESENGINE_INL
#define SOFA_COMPONENT_ENGINE_SHAPEFUNCTIONVALUESENGINE_INL

#include <sofa/component/engine/ShapeFunctionValuesEngine.h>
...
ShapeFunctionValuesEngine<DataTypes>::ShapeFunctionValuesEngine()
: values ( initData (&values, true,"values", "Computed values by shape functions on Input points") )
, derivatives ( initData (&derivatives,true, "derivative_values", "Computed values of derivative shape functions on Input points") )
...
{
	values.setGroup("Computing feature");
	derivatives.setGroup("Computing feature");
}


template <class DataTypes>
void ShapeFunctionValuesEngine<DataTypes>::init()
{
  addInput(&f_inputX);
  addOutput(&f_outputX);
  setDirtyValue();
...
template <class DataTypes>
void ShapeFunctionValuesEngine<DataTypes>::reinit()
{
    update();
}
...
template <class DataTypes>
void ShapeFunctionValuesEngine<DataTypes>::update()
{
   cleanDirty();
