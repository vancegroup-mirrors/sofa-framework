...
******************************************************************************/
#ifndef SOFA_COMPONENT_ENGINE_TRIANGLESINSPHEREROI_H
#define SOFA_COMPONENT_ENGINE_TRIANGLESINSPHEREROI_H
...
public:
    ...
    static std::string templateName(const TrianglesInSphereROI<DataTypes>* = NULL)
    {
...
#if defined(WIN32) && !defined(SOFA_COMPONENT_ENGINE_TRIANGLESINSPHEREROI_CPP)
#pragma warning(disable : 4231)
#ifndef SOFA_FLOAT
template class SOFA_COMPONENT_ENGINE_API TrianglesInSphereROI<defaulttype::Vec3dTypes>;
#endif //SOFA_FLOAT
#ifndef SOFA_DOUBLE
template class SOFA_COMPONENT_ENGINE_API TrianglesInSphereROI<defaulttype::Vec3fTypes>;
#endif //SOFA_DOUBLE
#endif
...
#endif //SOFA_COMPONENT_ENGINE_TRIANGLESINSPHEREROI_H
