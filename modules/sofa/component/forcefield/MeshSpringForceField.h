...
public:
	...
	: linesStiffness(initData(&linesStiffness,Real(100),"linesStiffness","Stiffness for the Lines",false))
	, linesDamping(initData(&linesDamping,Real(5),"linesDamping","Damping for the Lines",false))
	, trianglesStiffness(initData(&trianglesStiffness,Real(100),"trianglesStiffness","Stiffness for the Triangles",false))
	, trianglesDamping(initData(&trianglesDamping,Real(5),"trianglesDamping","Damping for the Triangles",false))
	, quadsStiffness(initData(&quadsStiffness,Real(100),"quadsStiffness","Stiffness for the Quads",false))
	, quadsDamping(initData(&quadsDamping,Real(5),"quadsDamping","Damping for the Quads",false))
	, tetrasStiffness(initData(&tetrasStiffness,Real(100),"tetrasStiffness","Stiffness for the Tetras",false))
	, tetrasDamping(initData(&tetrasDamping,Real(5),"tetrasDamping","Damping for the Tetras",false))
	, cubesStiffness(initData(&cubesStiffness,Real(100),"cubesStiffness","Stiffness for the Cubes",false))
	, cubesDamping(initData(&cubesDamping,Real(5),"cubesDamping","Damping for the Cubes",false))
