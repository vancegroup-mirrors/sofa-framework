...
* and F. Poyer                                                                 *
*******************************************************************************/
#ifndef SOFA_COMPONENT_FORCEFIELD_TETRAHEDRALBIQUADRATICSPRINGSFORCEFIELD_H
#define SOFA_COMPONENT_FORCEFIELD_TETRAHEDRALBIQUADRATICSPRINGSFORCEFIELD_H
...
class TetrahedralBiquadraticSpringsForceField : public core::componentmodel::behavior::ForceField<DataTypes>, public core::VisualModel
{
public:
...
protected: 
  ...
  class EdgeRestInformation
   ...
   class TriangleRestInformation
	{
	public:
		Real  c[3];	// the angular stiffness 
   ...
   class TetrahedronRestInformation
	...
	public:
		...
		Real c[12]; // the angular stiffness
		Real  d[3];	// the volumetric stiffness 
...
public:
	...
	TetrahedralBiquadraticSpringsForceField();

	TetrahedronSetTopology<DataTypes> *getTetrahedralTopology() const {return _mesh;}

	virtual ~TetrahedralBiquadraticSpringsForceField();
...
protected :
    ...
    static void TBSEdgeCreationFunction(int edgeIndex, void* param, EdgeRestInformation &ei,
                                         const Edge& ,  const helper::vector< unsigned int > &,
                                         const helper::vector< double >&);
    static void TBSTriangleCreationFunction(int triangleIndex, void* param, TriangleRestInformation &ei,
                                         const Triangle& ,  const helper::vector< unsigned int > &,
                                         const helper::vector< double >&);

	static void TBSTetrahedronCreationFunction (int , void* , 
							TetrahedronRestInformation &,
							const Tetrahedron& , const helper::vector< unsigned int > &, const helper::vector< double >&);
									

	static void TBSTetrahedronDestroyFunction ( int , void* , TetrahedronRestInformation &);
...
#endif /* _TetrahedralBiquadraticSpringsForceField_H_ */
