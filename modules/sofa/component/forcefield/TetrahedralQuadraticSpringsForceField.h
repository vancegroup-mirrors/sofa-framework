...
* and F. Poyer                                                                 *
*******************************************************************************/
#ifndef SOFA_COMPONENT_FORCEFIELD_TETRAHEDRALQUADRATICSPRINGSFORCEFIELD_H
#define SOFA_COMPONENT_FORCEFIELD_TETRAHEDRALQUADRATICSPRINGSFORCEFIELD_H
...
class TetrahedralQuadraticSpringsForceField : public core::componentmodel::behavior::ForceField<DataTypes>, public core::VisualModel
{
public:
...
protected: 
  ...
  class EdgeRestInformation
   ...
   class TriangleRestInformation
	{
	public:
		Real  angularStiffness[3];	// the angular stiffness 
   ...
   class TetrahedronRestInformation
	{
	public:
		Real stiffness[6]; // the elongation stiffness
		Real angularStiffness[12]; // the angular stiffness
		Real volumetricStiffness[3];	// the volumetric stiffness 
...
public:
	...
	TetrahedralQuadraticSpringsForceField();

	TetrahedronSetTopology<DataTypes> *getTetrahedralTopology() const {return _mesh;}

	virtual ~TetrahedralQuadraticSpringsForceField();
...
protected :
	...
	TriangleData<TriangleRestInformation> &getTriangleInfo() {return triangleInfo;}

    static void TQSEdgeCreationFunction(int edgeIndex, void* param, EdgeRestInformation &ei,
                                         const Edge& ,  const helper::vector< unsigned int > &,
                                         const helper::vector< double >&);
    static void TQSTriangleCreationFunction(int triangleIndex, void* param, TriangleRestInformation &ei,
                                         const Triangle& ,  const helper::vector< unsigned int > &,
                                         const helper::vector< double >&);

	static void TQSTetrahedronCreationFunction (int , void* , 
							TetrahedronRestInformation &,
							const Tetrahedron& , const helper::vector< unsigned int > &, const helper::vector< double >&);
									

	static void TQSTetrahedronDestroyFunction ( int , void* , TetrahedronRestInformation &);
...
#endif /* _TetrahedralQuadraticSpringsForceField_H_ */
