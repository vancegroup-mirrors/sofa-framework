...
;
#ifndef SOFA_FLOAT
template class SOFA_COMPONENT_INTERACTIONFORCEFIELD_API TriangleBendingSprings<Vec3dTypes>;
template class SOFA_COMPONENT_INTERACTIONFORCEFIELD_API TriangleBendingSprings<Vec2dTypes>;
#endif
#ifndef SOFA_DOUBLE
template class SOFA_COMPONENT_INTERACTIONFORCEFIELD_API TriangleBendingSprings<Vec3fTypes>;
template class SOFA_COMPONENT_INTERACTIONFORCEFIELD_API TriangleBendingSprings<Vec2fTypes>;
#endif
} // namespace interactionforcefield
