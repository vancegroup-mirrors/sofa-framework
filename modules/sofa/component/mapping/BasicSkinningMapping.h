...
******************************************************************************/
#ifndef SOFA_COMPONENT_MAPPING_BASICSKINNINGMAPPING_H
#define SOFA_COMPONENT_MAPPING_BASICSKINNINGMAPPING_H
...
class BasicSkinningMapping : public BasicMapping
{
public:
    SOFA_CLASS ( SOFA_TEMPLATE ( BasicSkinningMapping,BasicMapping ), BasicMapping );
        ...
        public:
          BasicSkinningMapping ( In* from, Out* to );
          virtual ~BasicSkinningMapping();
