...
******************************************************************************/
#ifndef SOFA_COMPONENT_MAPPING_BASICSKINNINGMAPPING_INL
#define SOFA_COMPONENT_MAPPING_BASICSKINNINGMAPPING_INL
...
BasicSkinningMapping<BasicMapping>::BasicSkinningMapping ( In* from, Out* to )
        : Inherit ( from, to )
...
template <class BasicMapping>
BasicSkinningMapping<BasicMapping>::~BasicSkinningMapping ()
{
}


template <class BasicMapping>
void BasicSkinningMapping<BasicMapping>::computeInitPos ( )
{
...
template <class BasicMapping>
void BasicSkinningMapping<BasicMapping>::computeDistances ()
{
    getDistances( 0);
}

template <class BasicMapping>
void BasicSkinningMapping<BasicMapping>::getDistances( int xfromBegin)
{
...
template <class BasicMapping>
void BasicSkinningMapping<BasicMapping>::sortReferences( vector<int>& references)
{
...
template <class BasicMapping>
void BasicSkinningMapping<BasicMapping>::init()
{
...
template <class BasicMapping>
void BasicSkinningMapping<BasicMapping>::clear()
{
    this->initPos.clear();
}

template <class BasicMapping>
void BasicSkinningMapping<BasicMapping>::setWeightsToHermite()
{
...
template <class BasicMapping>
void BasicSkinningMapping<BasicMapping>::setWeightsToLinear()
{
...
template <class BasicMapping>
void BasicSkinningMapping<BasicMapping>::setWeightsToInvDist()
{
...
template <class BasicMapping>
void BasicSkinningMapping<BasicMapping>::updateWeights ()
{
    VecCoord& xto = ( this->toModel->getX0() == NULL)?*this->toModel->getX():*this->toModel->getX0();
    VecInCoord& xfrom = *this->fromModel->getX0();
...
template <class BasicMapping>
void BasicSkinningMapping<BasicMapping>::setWeightCoefs ( VVD &weights )
{
    VVD * m_coefs = coefs.beginEdit();
    m_coefs->clear();
...
template <class BasicMapping>
void BasicSkinningMapping<BasicMapping>::setRepartition ( vector<int> &rep )
{
    vector<int> * m_reps = repartition.beginEdit();
    m_reps->clear();
...
template <class BasicMapping>
void BasicSkinningMapping<BasicMapping>::apply ( typename Out::VecCoord& out, const typename In::VecCoord& in )
{
    const vector<int>& m_reps = repartition.getValue();
...
template <class BasicMapping>
void BasicSkinningMapping<BasicMapping>::applyJ ( typename Out::VecDeriv& out, const typename In::VecDeriv& in )
{
    const vector<int>& m_reps = repartition.getValue();
    const VVD& m_coefs = coefs.getValue();
...
template <class BasicMapping>
void BasicSkinningMapping<BasicMapping>::applyJT ( typename In::VecDeriv& out, const typename Out::VecDeriv& in )
{
    const vector<int>& m_reps = repartition.getValue();
    const VVD& m_coefs = coefs.getValue();
...
template <class BasicMapping>
void BasicSkinningMapping<BasicMapping>::applyJT ( typename In::VecConst& out, const typename Out::VecConst& in )
{
    const vector<int>& m_reps = repartition.getValue();
    const VVD& m_coefs = coefs.getValue();
...
template <class BasicMapping>
void BasicSkinningMapping<BasicMapping>::draw()
{
