...
.add< SurfaceIdentityMapping< Mapping< State<Vec3dTypes>, MappedModel<Vec3dTypes> > > >()
.add< SurfaceIdentityMapping< Mapping< State<Vec3fTypes>, MappedModel<Vec3dTypes> > > >()
.add< SurfaceIdentityMapping< Mapping< State<Vec3dTypes>, MappedModel<Vec3fTypes> > > >()
.add< SurfaceIdentityMapping< Mapping< State<Vec3fTypes>, MappedModel<Vec3fTypes> > > >()
.add< SurfaceIdentityMapping< Mapping< State<Vec3dTypes>, MappedModel<ExtVec3dTypes> > > >()
.add< SurfaceIdentityMapping< Mapping< State<Vec3fTypes>, MappedModel<ExtVec3dTypes> > > >()
.add< SurfaceIdentityMapping< Mapping< State<Vec3dTypes>, MappedModel<ExtVec3fTypes> > > >()
.add< SurfaceIdentityMapping< Mapping< State<Vec3fTypes>, MappedModel<ExtVec3fTypes> > > >()
;
...
// Mech -> Mapped
template class SurfaceIdentityMapping< Mapping< State<Vec3dTypes>, MappedModel<Vec3dTypes> > >;
template class SurfaceIdentityMapping< Mapping< State<Vec3fTypes>, MappedModel<Vec3fTypes> > >;
template class SurfaceIdentityMapping< Mapping< State<Vec3dTypes>, MappedModel<Vec3fTypes> > >;
template class SurfaceIdentityMapping< Mapping< State<Vec3fTypes>, MappedModel<Vec3dTypes> > >;

// Mech -> ExtMapped
template class SurfaceIdentityMapping< Mapping< State<Vec3dTypes>, MappedModel<ExtVec3dTypes> > >;
template class SurfaceIdentityMapping< Mapping< State<Vec3fTypes>, MappedModel<ExtVec3fTypes> > >;
template class SurfaceIdentityMapping< Mapping< State<Vec3dTypes>, MappedModel<ExtVec3fTypes> > >;
template class SurfaceIdentityMapping< Mapping< State<Vec3fTypes>, MappedModel<ExtVec3dTypes> > >; 
