...
/** \brief Basic creation function for element of type T : simply calls default constructor.
		...
		public:
			...
			EdgeData( void (*createFunc) (int, void*, T&, const Edge &,const sofa::helper::vector< unsigned int >&, const sofa::helper::vector< double >&) = ed_basicCreateFunc,  void* createParam  = (void*)NULL, 
				void (*destroyFunc)(int, void*, T&                                     ) = ed_basicDestroyFunc, void* destroyParam = (void*)NULL ) 
