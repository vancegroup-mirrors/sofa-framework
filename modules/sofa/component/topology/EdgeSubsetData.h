...
/** \brief Basic creation function for element of type T : simply calls default constructor.
		...
		public:
			...
			EdgeSubsetData( void (*createFunc) (unsigned int, void*, T&, const Edge &,const std::vector< unsigned int >&, const std::vector< double >&) = ed_basicCreateFunc,  void* createParam  = (void*)NULL, 
				...
				,m_createParam(createParam), m_destroyParam(destroyParam),lastEdgeIndex(0)
			{}
