...
/** \brief Basic creation function for element of type T : simply calls default constructor.
        ...
        private:
            ...
            void (*m_createFunc)(int, void*, T&, const Quad&, const sofa::helper::vector< unsigned int >&, const sofa::helper::vector< double >& );
        ...
        public:
			...
			QuadData( void (*createFunc) (int, void*, T&, const Quad& ,const sofa::helper::vector< unsigned int >&, const sofa::helper::vector< double >&) = trd_basicCreateFunc,  void* createParam  = (void*)NULL, 
