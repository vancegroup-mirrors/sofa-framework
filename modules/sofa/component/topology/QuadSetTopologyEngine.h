...
******************************************************************************/
#ifndef SOFA_COMPONENT_TOPOLOGY_QUADSETTOPOLOGYENGINE_H
#define SOFA_COMPONENT_TOPOLOGY_QUADSETTOPOLOGYENGINE_H
...
namespace topology
{
   ...
   class QuadSetTopologyEngine : public sofa::core::topology::TopologyEngine
   {
   public:
      //SOFA_CLASS(QuadSetTopologyEngine, sofa::core::topology::TopologyEngine);
      typedef QuadData<T,Alloc> t_topologicalData;
      ...
      QuadSetTopologyEngine();

      QuadSetTopologyEngine(t_topologicalData* _topologicalData);

      QuadSetTopologyEngine(t_topologicalData* _topologicalData, sofa::core::topology::BaseMeshTopology* _topology);

      virtual ~QuadSetTopologyEngine() {}
...
#endif // SOFA_COMPONENT_TOPOLOGY_QUADSETTOPOLOGYENGINE_H
