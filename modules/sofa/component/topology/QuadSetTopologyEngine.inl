...
******************************************************************************/
#ifndef SOFA_COMPONENT_TOPOLOGY_QUADSETTOPOLOGYENGINE_INL
#define SOFA_COMPONENT_TOPOLOGY_QUADSETTOPOLOGYENGINE_INL
...
namespace topology
{
   ...
   QuadSetTopologyEngine<T,Alloc>::QuadSetTopologyEngine() : sofa::core::topology::TopologyEngine(),
   m_topology(NULL),
   m_quadsLinked(false), m_hexahedraLinked(false)
   {
      this->init();
   }
   ...
   template <typename T, typename Alloc>
   QuadSetTopologyEngine<T,Alloc>::QuadSetTopologyEngine(QuadData<T, Alloc> *_topologicalData) :
   ...
   template <typename T, typename Alloc>
   QuadSetTopologyEngine<T,Alloc>::QuadSetTopologyEngine(QuadData<T, Alloc> *_topologicalData, sofa::core::topology::BaseMeshTopology *_topology) :
   m_topologicalData(_topologicalData),
   m_topology(NULL),
   m_quadsLinked(false), m_hexahedraLinked(false)
   {
   ...
   template <typename T, typename Alloc>
   void QuadSetTopologyEngine<T,Alloc>::init()
   {
   ...
   template <typename T, typename Alloc>
   void QuadSetTopologyEngine<T,Alloc>::reinit()
   {
      this->update();
   }

   template <typename T, typename Alloc>
   void QuadSetTopologyEngine<T,Alloc>::update()
   {
   ...
   template <typename T, typename Alloc>
   void QuadSetTopologyEngine<T,Alloc>::registerTopology(sofa::core::topology::BaseMeshTopology *_topology)
   {
      m_topology =  dynamic_cast<sofa::core::topology::TopologyContainer*>(_topology);
   ...
   template <typename T, typename Alloc>
   void QuadSetTopologyEngine<T,Alloc>::ApplyTopologyChanges()
   {
      ...
      for (changeIt=_changeList.begin(); changeIt!=_changeList.end(); ++changeIt)
      {
         ...
         {
            // Events concerning QuadsTriangleSetTopologyEngine
         case core::topology::QUADSADDED:
            {
               const QuadsAdded *qa=static_cast< const QuadsAdded * >( *changeIt );
               m_topologicalData->add( qa->getNbAddedQuads(), qa->quadArray, qa->ancestorsList, qa->coefs );
               break;
            }
...
template <typename T, typename Alloc>
void QuadSetTopologyEngine<T,Alloc>::setCreateFunction(t_createFunc createFunc)
{
...
template <typename T, typename Alloc>
void QuadSetTopologyEngine<T,Alloc>::setDestroyFunction(t_destroyFunc destroyFunc)
{
   if (m_topologicalData)
   {
      // Transfert pointer to function To EdgeData
...
template <typename T, typename Alloc>
void QuadSetTopologyEngine<T,Alloc>::setCreateHexahedronFunction(t_createHexahedronFunc createHexahedronFunc)
{
   if (m_topologicalData)
   {
...
template <typename T, typename Alloc>
void QuadSetTopologyEngine<T,Alloc>::setDestroyHexahedronFunction(t_destroyHexahedronFunc destroyHexahedronFunc)
{
   if (m_topologicalData)
   {
      // Transfert pointer to function To PointData
...
template <typename T, typename Alloc>
void QuadSetTopologyEngine<T,Alloc>::setDestroyParameter( void* destroyParam )
{
   if (m_topologicalData)
...
template <typename T, typename Alloc>
void QuadSetTopologyEngine<T,Alloc>::setCreateParameter( void* createParam )
{
   if (m_topologicalData)
...
template <typename T, typename Alloc>
void QuadSetTopologyEngine<T,Alloc>::linkToQuadDataArray()
{
...
template <typename T, typename Alloc>
void QuadSetTopologyEngine<T,Alloc>::linkToHexahedronDataArray()
{
