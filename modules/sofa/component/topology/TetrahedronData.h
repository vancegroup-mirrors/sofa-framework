...
/** \brief Basic creation function for element of type T : simply calls default constructor.
		...
		> 
		class TetrahedronData : public sofa::helper::vector<T, Alloc> {
		public:
			/// size_type
        ...
        public:
			...
			/// Constructor
			TetrahedronData(size_type n, const T& value): sofa::helper::vector<T,Alloc>(n,value) {}
			/// Constructor
			TetrahedronData(int n, const T& value): sofa::helper::vector<T,Alloc>(n,value) {}
			/// Constructor
			TetrahedronData(long n, const T& value): sofa::helper::vector<T,Alloc>(n,value) {}
			/// Constructor
			explicit TetrahedronData(size_type n): sofa::helper::vector<T,Alloc>(n) {}
			/// Constructor
			TetrahedronData(const sofa::helper::vector<T, Alloc>& x): sofa::helper::vector<T,Alloc>(x) {}


#ifdef __STL_MEMBER_TEMPLATES
			/// Constructor
			template <class InputIterator>
			TetrahedronData(InputIterator first, InputIterator last): sofa::helper::vector<T,Alloc>(first,last){}
#else /* __STL_MEMBER_TEMPLATES */
			/// Constructor
			TetrahedronData(typename TetrahedronData<T>::const_iterator first, typename TetrahedronData<T,Alloc>::const_iterator last): sofa::helper::vector<T,Alloc>(first,last){}
			...
			TetrahedronData( void (*createFunc) (int, void*, T&,const Tetrahedron& , const sofa::helper::vector< unsigned int >&, const sofa::helper::vector< double >&) = td_basicCreateFunc,  void* createParam  = (void*)NULL, 
				void (*destroyFunc)(int, void*, T&                                     ) = td_basicDestroyFunc, void* destroyParam = (void*)NULL ) 
