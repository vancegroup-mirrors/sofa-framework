...
void InteractiveCamera::processMouseEvent(core::objectmodel::MouseEvent* me)
{
        ...
        if(me->getState() == core::objectmodel::MouseEvent::RightPressed)
        {
                isMoving = true;
        ...
        if(me->getState() == core::objectmodel::MouseEvent::MiddlePressed)
        {
                isMoving = true;
        ...
        if(me->getState() == core::objectmodel::MouseEvent::RightReleased)
        {
                isMoving = false;
                currentMode = NONE_MODE;
        }
        else
        if(me->getState() == core::objectmodel::MouseEvent::MiddleReleased)
        {
                isMoving = false;
                currentMode = NONE_MODE;
        }
