...
void MonoFrequencyObjSubAutomate::addPattern()
{
	...
	execCond->setVisitor(&ObjSubAutomate::execTest);
...
void MonoFrequencyObjSubAutomate::setVisitorList(std::vector<MonoFrequencyObjSubAutomateAttribute *> _list)
{
