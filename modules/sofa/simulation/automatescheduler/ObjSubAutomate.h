...
public :
	...
	void setVisitorList(std::vector<MonoFrequencyObjSubAutomateAttribute *>);

	const std::vector<MonoFrequencyObjSubAutomateAttribute *>& getVisitorList() { return actionList; }
