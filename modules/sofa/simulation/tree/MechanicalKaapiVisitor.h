...
class MechanicalPropagateAndAddDxAction : public MechanicalAction
{
public:
    VecId dx;
    MechanicalPropagateAndAddDxAction(VecId dx) : dx(dx)
    {}
    virtual Result fwdMechanicalState(GNode* /*node*/, core::componentmodel::behavior::BaseMechanicalState* mm)
    {
        mm->setDx(dx);
...
This action is typically applied after time integration of the independent degrees of freedom.
 */
class MechanicalPropagateFreePositionAction : public MechanicalAction
{
public:
    double t;
    VecId xfree;
	MechanicalPropagateFreePositionAction(double time=0, VecId xfree = VecId::freePosition()): t(time), xfree(xfree)
	{
	}
	virtual Result processNodeTopDown(GNode* node)
	{
...
public:
    VecId res;
	double **W;
    MechanicalApplyConstraintsAction(VecId res, double **W = NULL) : res(res), W(W)
    {}
    virtual Result fwdMechanicalState(GNode* /*node*/, core::componentmodel::behavior::BaseMechanicalState* mm)
    {
        mm->setDx(res);
...
class MechanicalAddMBK_ToMatrixAction : public MechanicalAction
{
public:
    BaseMatrix *mat;
    double m, b, k;
    ...
    MechanicalAddMBK_ToMatrixAction(BaseMatrix *_mat, double _m=1.0, double _b=1.0, double _k=1.0, unsigned int _offset=0)
...
class MechanicalAddMBKdx_ToVectorAction : public MechanicalAction
{
public:
//    SofaBaseVector *vect;
    unsigned int offset, offsetBckUp;

    MechanicalAddMBKdx_ToVectorAction(VecId /*res*/, VecId /*dx*/, double /*mFact=1.0*/, double /*bFact=1.0*/, double /*kFact=1.0*/)
    {}
...
class MechanicalMultiVector2BasicVectorAction : public MechanicalAction
{
public:
	MechanicalMultiVector2BasicVectorAction(VecId /*src*/, defaulttype::BaseVector * /*dest=NULL */, unsigned int /* offset=0 */)
	{
	}
};
...
class MechanicalComputeComplianceAction : public MechanicalAction
{
public:
	MechanicalComputeComplianceAction( double **W):_W(W)
	{
	}
...
This action is typically called after a MechanicalResetForceAction.
 */
class MechanicalComputeContactForceAction : public MechanicalAction
{
public:
    VecId res;
    MechanicalComputeContactForceAction(VecId res) : res(res)
    {}
    virtual Result fwdMechanicalState(GNode* /*node*/, core::componentmodel::behavior::BaseMechanicalState* mm)
    {
        mm->setF(res);
