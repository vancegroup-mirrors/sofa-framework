...
* and F. Poyer                                                                 *
*******************************************************************************/
#ifndef SOFA_SIMULATION_TREE_VelocityThresholdVisitor_H
#define SOFA_SIMULATION_TREE_VelocityThresholdVisitor_H
...
public:
    ...
    virtual Visitor::Result processNodeTopDown(GNode* node);
