...
#include <algorithm>
#include <map>
#include "Sofa-old/GUI/QT/Coin/oi.h"
using namespace oi;
...
//typedef std::istringstream std::istringstream; ///< use a string as input
...
public:
        ...
        */
        inline void operator () ( int argc, char** argv )
        {
                ...
                std::istringstream str( cmdLine.c_str() );
                (*this)( str );
...
inline ArgumentParser parse( const std::string& helpstr, char hs, const std::string& hl ){
